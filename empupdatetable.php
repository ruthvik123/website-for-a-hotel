...
<form action="empupdatehtml.php" method="get">
		<div>
		<thead>
			<tr>
				<th> </th>
...
while($row = mysql_fetch_array($result))
  {
  echo "<tr>";
  echo "<td> <input type='radio' name='update' value=".$row['id']."></td>";
  echo "<td>" . $row['name'] . "</td>";
  echo "<td>" . $row['id'] . "</td>";
  ...
  echo "</tr>";
	...
	<div style="align:center;padding-left:300px;padding-top:50px;">
	</div>
	<br>
	<br>
</body>
