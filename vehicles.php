...
<form method="POST" action="cabbook.php" name="cab">
...
</td><td><br>MOBILE NO</td><td><br><input type="int" pattern="[0-9]{10}" name="mobno" required></td>
<td>TIME</td><td><br><input type="time" name="time" required></td>
...
if(strpos($url,"book=success")){
	echo "<br>" ;
	echo "booked a cab successfully" ;
}
